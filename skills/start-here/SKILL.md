...
- Prefer observation-backed structure exploration over blind parameter tuning.
...
- If you need to diagnose bottlenecks or justify structure changes, read `skills/explore-structure-from-observations/SKILL.md`.
...
- Tuning parameters repeatedly without first checking whether the structure is the real bottleneck.
